...
class CreateCompany implements Tool
{
    ...
    public function handle(Request $request): Stringable|string
    {
        ...
        $data = array_filter([
            ...
            'bank_ifsc_code'      => $request['bank_ifsc_code'] ?? null,
    ...
    public function schema(JsonSchema $schema): array
    {
        return [
            ...
            'bank_account_name'   => $schema->string()->description('Name on the bank account'),
            'bank_account_number' => $schema->string()->description('Bank account number'),
            'bank_ifsc_code'      => $schema->string()->description('Bank IFSC code'),
            'bank_name'           => $schema->string()->description('Name of the bank'),
            'bank_branch'         => $schema->string()->description('Bank branch name'),
